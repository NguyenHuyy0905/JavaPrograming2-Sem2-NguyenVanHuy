...
public class StudentFileIO {
    ...
    private static void saveToFile(List<Student> studentList) {
        try (BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream("students.txt"))) {
    ...
    private static void loadFromFile(List<Student> studentList) {
        ...
        try (BufferedInputStream bis = new BufferedInputStream(new FileInputStream("students.txt"))) {
